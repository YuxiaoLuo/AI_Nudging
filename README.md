...
This is the research repository for the AI nudging project.
...
4. `manuscript_package_index.md`
5. `manuscript_llm_ai_nudges_draft.md`
...
9. `manuscript_reference_audit.md`
