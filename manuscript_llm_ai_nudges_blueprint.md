...
Given the current literature set, the strongest anchors for the core theoretical background should remain compact. The baseline digital-guidance portion should lean primarily on Häubl and Trifts (2000), Senecal and Nantel (2004), and Ursu (2018). The advisory and transparency bridge should lean primarily on Wang and Benbasat (2007), Wang et al. (2018), Wang and Wang (2019), and likely Luo et al. (2019). Other papers can still be valuable, but they should enter only when they sharpen one of the manuscript's core theoretical moves rather than merely adding topical breadth.
